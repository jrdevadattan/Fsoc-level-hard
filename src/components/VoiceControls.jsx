...
const VoiceControls = ({
    ...
    useEffect(() => {
        if (
            ...
            // Use original answer order for voice parsing to avoid shuffle confusion
            ...
            if (answer) {
                ...
                onSpeak(
                    "I didn't understand that. Please say A, B, C, or D, or option A, option B, etc.",
                );
                setTranscript("");
            }
        }
    ...
    const handleSoundClick = () => {
        if (isSpeaking) {
            ...
            // Always use original order for voice to maintain consistency
    ...
    return (
        <div className="flex gap-2 items-start">
            ...
            <button
                ...
                disabled={
                    !question || selectedAnswer || isTimedOut || showResult
                }
                className={`p-3 rounded-full transition-all duration-300 shadow-lg ${
                    isListening
