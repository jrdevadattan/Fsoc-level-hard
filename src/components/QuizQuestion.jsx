...
const QuizQuestion = ({ question, onAnswerSelect, selectedAnswer }) => {
  ...
  const getButtonClass = (answer) => {
    ...
    if (!selectedAnswer && !clickedAnswer) {
      return baseClass + "bg-white hover:bg-purple-50 hover:scale-105 hover:shadow-lg text-gray-800 border-2 border-transparent hover:border-purple-300";
    }
