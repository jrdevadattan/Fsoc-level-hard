...
const QuizQuestion = ({ question, onAnswerSelect, selectedAnswer, isTimerEnabled }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-2xl p-8 max-w-3xl mx-auto" data-quiz-question="true">
      <div className="mb-8">
